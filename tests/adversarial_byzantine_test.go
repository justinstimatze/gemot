...
func (h *byzantineHarness) runRound(
	...
	if err := h.weigher.UpdateFromRound(ctx, result.Cruxes, authors, nil); err != nil {
...
func TestByzantineGraduationCliff(t *testing.T) {
	...
	if err := h.weigher.UpdateFromRound(ctx, cruxesR1, authorsR1, nil); err != nil {
	...
	if err := h.weigher.UpdateFromRound(ctx, cruxesR2, authorsR2, nil); err != nil {
