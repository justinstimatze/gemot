...
func (h *byzantineHarness) runRound(
	...
	if err := h.weigher.UpdateFromRound(ctx, result.Cruxes, authors); err != nil {
...
func TestByzantineGraduationCliff(t *testing.T) {
	...
	if err := h.weigher.UpdateFromRound(ctx, cruxesR1, authorsR1); err != nil {
	...
	if err := h.weigher.UpdateFromRound(ctx, cruxesR2, authorsR2); err != nil {
